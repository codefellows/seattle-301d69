...
function displayPics(){
  ...
  //ANSWER: "let rando" is occurring within the code block of the function displayPics but the console log on line 38 is attempting to utilize it so there is an error saying it is not defined as it is only defined within that function.
  console.log(viewed);
