...
//    Arrow functions do not reset the 'this' context, it remains the the same as it would be for the enclosing scope or the window object if there is no 'non-arrow' enclosing scope. Which is why we should not use them in constructor functions.
